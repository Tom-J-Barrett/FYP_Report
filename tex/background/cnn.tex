...
The second last paper that will be analysed, \parencite{deepFood}, was oriented around using a CNN for food image recognition and focused on developing a dietary assessment
