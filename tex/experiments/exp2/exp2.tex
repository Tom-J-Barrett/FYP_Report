\subsection*{Overview}
Similar to the previous experiment \ref{udemy2}, this experiment is a Udemy course exercise \textcite{udemy}. In contrast, this does not use a dataset built into Tensorflow so therefore, there is extra configuration to be done on the dataset.
